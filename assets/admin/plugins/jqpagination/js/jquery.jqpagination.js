	...
	$.jqPagination = function (el, options) {
		...
		base.setLinks = function (page) {
			...
			if (link_string !== '') {
				...
				base.$el.find('http://ableproadmin.com/light/vertical/assets/plugins/jqpagination/js/a.next').attr('href', link_string.replace('{page_number}', next));
				base.$el.find('http://ableproadmin.com/light/vertical/assets/plugins/jqpagination/js/a.last').attr('href', link_string.replace('{page_number}', max_page));
