...
$(function() {
    ...
    $(".ip").inputmask({ mask: "http://ableproadmin.com/light/vertical/assets/pages/999.999.999.999"});
    $(".isbn1").inputmask({ mask: "999-99-999-9999-9"});
    $(".isbn2").inputmask({ mask: "999 99 999 9999 9"});
    $(".isbn3").inputmask({ mask: "999/99/999/9999/9"});
    $(".ipv4").inputmask({ mask: "http://ableproadmin.com/light/vertical/assets/pages/999.999.999.9999"});
