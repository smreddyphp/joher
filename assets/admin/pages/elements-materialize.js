...
// Dropdown Js
    ...
    $(document.body).on('mousedown', '.materialBtn, .md-select li', function(event){
            if(parseFloat($(this).css('opacity')) > 0 && $(document).width() >= 1008){
                ...
                if($(this).find("http://ableproadmin.com/light/vertical/assets/pages/b.drop").length == 0 || $(this).find("http://ableproadmin.com/light/vertical/assets/pages/b.drop").css('opacity') != 1) {
                    ...
                    $(this).find("http://ableproadmin.com/light/vertical/assets/pages/b.drop").each(function(){
