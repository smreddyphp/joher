<!-- CONTENT-WRAPPER-->
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header"><h5 class="card-header-text"><?php echo @$page_name; ?> (Name: <?php echo $this->db->where('user_id',$this->uri->segment(3))->get('users')->row()->user_name;?>)</h5><span>
  ...
  <section>
   ...
   <script>     
        ...
        $('.delete_team_mem').on('click',function(event){ 
            ...
            var id = $(this).data('id');
              $.ajax({                
                    url: "<?php echo base_url();?>admin/delete_data/login_info",
                    type: "POST",
                    data: {id:id},
