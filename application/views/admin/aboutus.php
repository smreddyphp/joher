      ...
      <div class="col-sm-12">
        ...
        <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <form method = "POST">
                            <?php //print_r($about_us);?>    
                            <div class="form-group row">
                                <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">About-Us(EN)</label>
                                <div class="col-sm-9">
                                    <!--<input class="form-control" type="text" name="data[category_name]" value="" placeholder="Terms & Condition">-->
                                    <textarea name="data[about_us_en]" id="editor1" rows="10" cols="80"><?=$about_us['about_us_en']?></textarea>
                                    <span style = "color:red"></span>
                                </div>
                            </div>
                            
                            <div class="form-group row">
                                <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">About-Us(AR)</label>
                                <div class="col-sm-9">
                                   <!-- <input class="form-control" type="text" name="data[category_name]" value="" placeholder="Terms & Condition">-->
                                    <textarea name="data[about_us_ar]" id="editor2" rows="10" cols="80"><?=$about_us['about_us_ar']?></textarea>
                                    <span style = "color:red"></span>
                                </div>
                            </div>
