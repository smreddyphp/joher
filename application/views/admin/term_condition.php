      ...
      <div class="col-sm-12">
        ...
        <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <form method = "POST">
                            <?php //print_r($term_condition);?>    
                            <div class="form-group row">
                                <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Terms & Condition(EN)</label>
                                <div class="col-sm-9">
                                    <!--<input class="form-control" type="text" name="data[category_name]" value="" placeholder="Terms & Condition">-->
                                    <textarea name="data[term_condition_en]" id="editor1" rows="10" cols="80"><?=$term_condition['term_condition_en']?></textarea>
                                    <span style = "color:red"></span>
                                </div>
                            </div>
                            
                            <div class="form-group row">
                                <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Terms & Condition(AR)</label>
                                <div class="col-sm-9">
                                   <!-- <input class="form-control" type="text" name="data[category_name]" value="" placeholder="Terms & Condition">-->
                                    <textarea name="data[term_condition_ar]" id="editor2" rows="10" cols="80"><?=$term_condition['term_condition_ar']?></textarea>
                                    <span style = "color:red"></span>
                                </div>
                            </div>
