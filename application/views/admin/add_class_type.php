        ...
        <div class="modal-body">
            <form id="insert_adds" method="post">                         
                ...
                <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Add Class Type</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="text" name="data[class_type]" value="<?php echo @$value['class_type']?>" placeholder="Enter Class" >
                    </div>
                </div>
