...
<div class="modal-dialog" role="document">
    <div class="modal-content" style="overflow:hidden">
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Hotel Chain </h4>
        </div>
        <div class="modal-body">
            <form id="insert_adds" method="post">                         
                
                <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Add Hotel Chain</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="text" name="data[hotel_chain]" value="<?php echo @$value['hotel_chain']?>" placeholder="Enter Hotel Chain" >
                    </div>
                </div>
