...
<style>
    #insert_miscellaneous label.error {
        color:red; 
    }
    #insert_miscellaneous input.error,textarea.error,select.error {
      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-block addform-block">
			<form id="insert_miscellaneous" method="post" >
         <!-- Form Name -->
            ...
            <div class="col-sm-9">
               ...
               //print_r($client_code);
                  ...
                  { 
                    foreach($res as $row)
                      { ?>
                       <option value = "<?=$row->client_code?>"  <?php if($row->client_code == @$miscellaneous['client_code']){ echo 'selected';}else{ echo 'selected';}?> ><?=$row->client_code?></option>   
                     <?php  } }?>                
                   </select>
                 <?php }
                 else
                  {  ?>
                    ...
                    if($res){ 
                      foreach($res as $row)
                        { ?>
                         <option value = "<?=$row->client_code?>"  <?php if($row->client_code == @$miscellaneous['client_code']){ echo 'selected';}?> ><?=$row->client_code?></option>   
                       <?php  }
                     }
                     ?>
                   </select>
...
<div class="form-group">
            ...
            <select class="form-control" name="data[trip_id]"  id="get_trip_id">
                    ...
                    <?php 
                        ...
                        { 
                            foreach($res as $row)
                            { ?>
                                 <option value = "<?=$row->id?>"  <?php if($row->id == @$miscellaneous['trip_id']){ echo 'selected';}else if($row->id == $this->uri->segment(5)){ echo 'selected'; } ?> ><?=$row->id?></option>   
                        <?php  }
                        } ?>
            </select>
	</div>
            ...
            <select class="form-control" name="data[client_name]" id="get_client_name" >
                ...
                <?php 
                    ...
                    if($res){ 
                        foreach($res as $row)
                        { ?>
                         <option value ="<?=$row->user_name?>" <?php if($row->user_name == @$miscellaneous['client_name']){ echo 'selected';}else if($row->user_name==@$miscellaneous['client_name']){ echo 'selected';}?>><?=$row->user_name?></option>   
                    <?php  }
                    }
                ?>
            </select>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
             <select name="data[service_type]" id="" class="form-control">
              ...
              <option value="Miscellaneous" <?php if(@$miscellaneous['service_type']=='Miscellaneous'){ echo 'selected';} ?>>Miscellaneous</option>
              </select>
            </div>
          </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <?php 
                    $res = $this->db->get_where('suppliers',array('service_type'=>'MISC'))->result();
                    if($res){ 
                        foreach($res as $row)
                        { ?>
                         <option value ="<?=$row->supplier_code?>" <?php if($row->supplier_code == @$miscellaneous['supplier_code']){ echo 'selected';}?> ><?=$row->supplier_code?></option>   
                    <?php  }
                    }
                ?>
            </select>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="data[supplier_name]" id="get_supplier_name" onchange = "supplier_name(this.value)" >
                ...
                <?php 
                    ...
                    if($res){ 
                        foreach($res as $row)
                        { ?>
                         <option value ="<?=$row->supplier_name?>" <?php if($row->supplier_name == @$miscellaneous['supplier_name']){ echo 'selected';}?>><?=$row->supplier_name?></option>   
                    <?php  }
                    }
                ?>
            </select>
            ...
            <div class="col-sm-9">
              <input class="form-control" type="text" name="data[confirmation_no]" value="<?php echo @$miscellaneous['confirmation_no']?>" placeholder="Enter Confirmation Number" >
            </div>
          </div>
      ...
      <div class="form-group ">
        ...
        <div class="col-sm-9">
          <select name="data[payment_method]" id="" class="form-control">
            ...
            <option value="ONLINE" <?php if(@$miscellaneous['payment_method']=='ONLINE'){ echo 'selected';} ?>>ONLINE</option>
            <option value="CREDIT_CARD" <?php if(@$miscellaneous['payment_method']=='CREDIT_CARD'){ echo 'selected';} ?>>CREDIT CARD</option>
            <option value="DEBIT_CARD" <?php if(@$miscellaneous['payment_method']=='DEBIT_CARD'){ echo 'selected';} ?>>DEBIT CARD</option>
            <option value="CASH"<?php if(@$miscellaneous['payment_method']=='CASH'){echo 'selected';} ?>>CASH</option>
              <option value="TBA"<?php if(@$miscellaneous['payment_method']=='TBA'){echo 'selected';} ?>>TBA</option>
          </select>
        </div>
      </div> 
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-9">
              <input class="form-control" type="number" name="data[fee_details]" value="<?php echo @$miscellaneous['fee_details']?>" placeholder="Enter Fee" >
            </div>
          </div>          
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-9">
              <input class="form-control" type="date" id ="from_date" name="data[from]" value="<?php echo @$miscellaneous['from']?>"  placeholder="Enter Depature Date" >
            </div>
          </div>
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-9">
              <input class="form-control" type="date" id ="to_date" name="data[to]" value="<?php echo @$miscellaneous['to']?>"  placeholder="Enter Arrival Date" >
            </div>
          </div> 
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-9">
             <input class="form-control" type="text" name="data[joher_proform]" value="<?php echo @$miscellaneous['joher_proform']?>" placeholder="Enter Proform No" >             
            </div>
          </div>
            <div class="form-group ">
            <label class="col-sm-3 control-label" for="textinput">Joher Invoice:</label>
            <div class="col-sm-9">
           <input class="form-control" type="text" name="data[joher_invoice]" value="<?php echo @$miscellaneous['joher_invoice']?>" placeholder="Enter Invoice No" >             
            </div>
          </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <select name="data[fcr]" name="data[frc]" id="fcrCode" class="form-control wi">
                                ...
                                <?php 
                                    ...
                                    { ?>
                                         <option value = "<?php echo @$row2['id']?>" <?php if($row2['id'] == @$miscellaneous['fcr']){ echo "selected";} ?> ><?=@$row2['country_code']?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <label class="col-sm-2 control-label text-center" for="textinput">Buy FOREX:</label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[buy_forex]" id = "buy_forex" value = "<?php echo @$miscellaneous['buy_forex']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput">Sell FOREX:</label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[sel_forex]" id = "sel_forex" value = "<?php echo @$miscellaneous['sel_forex']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[supplier_base_rate]" id = "supplier_base_rate" value = "<?php echo @$miscellaneous['supplier_base_rate']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_base_rate_buy]" id = "supplier_base_rate_buy" value = "<?php echo @$miscellaneous['supplier_base_rate_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_base_rate_sel]" id = "supplier_base_rate_sel" value = "<?php echo @$miscellaneous['supplier_base_rate_sel']?>" class="form-control wi">  
                        </div>
                    </div>          
                </div>
        </div> 
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[total_supplier_base_rate]" id = "total_supplier_base_rate" value = "<?php echo @$miscellaneous['total_supplier_base_rate']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_supplier_base_rate_buy]" id = "total_supplier_base_rate_buy" value = "<?php echo @$miscellaneous['total_supplier_base_rate_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_supplier_base_rate_sel]" id = "total_supplier_base_rate_sel" value = "<?php echo @$miscellaneous['total_supplier_base_rate_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[supplier_tax]" id = "supplier_tax" value = "<?php echo @$miscellaneous['supplier_tax']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_tax_buy]" id = "supplier_tax_buy" value = "<?php echo @$miscellaneous['supplier_tax_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_tax_sel]" id = "supplier_tax_sel" value = "<?php echo @$miscellaneous['supplier_tax_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[other_fees]" id = "other_fees" value = "<?php echo (@$miscellaneous['other_fees'])?@$miscellaneous['other_fees']:'0.00'?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[other_fees_buy]" id = "other_fees_buy" value = "<?php echo (@$miscellaneous['other_fees_buy'])?@$miscellaneous['other_fees_buy']:'0.00'?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[other_fees_sel]" id = "other_fees_sel" value = "<?php echo (@$miscellaneous['other_fees_sel'])?@$miscellaneous['other_fees_sel']:'0.00'?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[supplier_total]" id = "supplier_total" value = "<?php echo @$miscellaneous['supplier_total']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_total_buy]" id = "supplier_total_buy" value = "<?php echo @$miscellaneous['supplier_total_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_total_sel]" id = "supplier_total_sel" value = "<?php echo @$miscellaneous['supplier_total_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[actual_supplier_total]" id = "actual_supplier_total" value = "<?php echo @$miscellaneous['actual_supplier_total']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[actual_supplier_total_buy]" id = "actual_supplier_total_buy" value = "<?php echo @$miscellaneous['actual_supplier_total_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[actual_supplier_total_sel]" id = "actual_supplier_total_sel" value = "<?php echo @$miscellaneous['actual_supplier_total_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[commission1]" id = "commission1" value = "<?php echo @$miscellaneous['commission1']?>" class="form-control wi">
                        </div>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[commission_per]" id = "commission_per" value = "<?php echo @$miscellaneous['commission_per']?>" class="form-control " placeholder="%">%  
                        </div>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[commission_buy]" id = "commission_buy" value = "<?php echo @$miscellaneous['commission_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[commission_sel]" id = "commission_sel" value = "<?php echo @$miscellaneous['commission_sel']?>" class="form-control wi">  
                        </div>
                    </div>          
                </div>
         </div>  
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[markup1]" id = "markup1" value = "<?php echo @$miscellaneous['markup1']?>" class="form-control wi">
                        </div>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[markup_per]" id = "markup_per" value = "<?php echo @$miscellaneous['markup_per']?>" class="form-control" placeholder="%">%  
                        </div>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[markup_buy]" id = "markup_buy" value = "<?php echo @$miscellaneous['markup_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[markup_sel]" id = "markup_sel" value = "<?php echo @$miscellaneous['markup_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[total_wo_vat]" id = "total_wo_vat" value = "<?php echo @$miscellaneous['total_wo_vat']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_wo_vat_buy]" id = "total_wo_vat_buy" value = "<?php echo @$miscellaneous['total_wo_vat_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_wo_vat_sel]" id = "total_wo_vat_sel" value = "<?php echo @$miscellaneous['total_wo_vat_sel']?>" class="form-control wi">  
                        </div>
                    </div>          
                </div>
          </div>  
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[vat_commission]" id = "vat_commission" value = "<?php echo @$miscellaneous['vat_commission']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_commission_buy]" id = "vat_commission_buy" value = "<?php echo @$miscellaneous['vat_commission_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_commission_sel]" id = "vat_commission_sel" value = "<?php echo @$miscellaneous['vat_commission_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[vat_markup]" id = "vat_markup" value = "<?php echo @$miscellaneous['vat_markup']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_markup_buy]" id = "vat_markup_buy" value = "<?php echo @$miscellaneous['vat_markup_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_markup_sel]" id = "vat_markup_sel" value = "<?php echo @$miscellaneous['vat_markup_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[vat_forex]" id = "vat_forex" value = "<?php echo (@$miscellaneous['vat_forex'])?@$miscellaneous['vat_forex']:'0.00'?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_forex_buy]" id = "vat_forex_buy" value = "<?php echo (@$miscellaneous['vat_forex_buy'])?@$miscellaneous['vat_forex_buy']:'0.00'?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_forex_sel]" id = "vat_forex_sel" value = "<?php echo (@$miscellaneous['vat_forex_sel'])?@$miscellaneous['vat_forex_sel']:'0.00'?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[total_w_vat]" id = "total_w_vat" value = "<?php echo @$miscellaneous['total_w_vat']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_w_vat_buy]" id = "total_w_vat_buy" value = "<?php echo @$miscellaneous['total_w_vat_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_w_vat_sel]" id = "total_w_vat_sel" value = "<?php echo @$miscellaneous['total_w_vat_sel']?>" class="form-control wi">  
                        </div>
         ...
         <div class="form-group ">
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="col-sm-3">
                 <div class="radio">
                  <input type="radio" name="data[urgency_level]"  <?php if(@$miscellaneous['urgency_level'] == 0){ echo 'checked';} ?> id="radio1" value = "1">
                  <label for="radio1"> 0 </label>
                </div>
                <div class="radio">
                  <input type="radio" name="data[urgency_level]" id="radio2" value = "1" <?php if(@$miscellaneous['urgency_level'] == 1){ echo 'checked';} ?>>
                  <label for="radio2"> 1  </label>
                </div>
                <div class="radio">
                  <input type="radio" name="data[urgency_level]" id="radio3" value = "2" <?php if(@$miscellaneous['urgency_level'] == 2){ echo 'checked';} ?> >
                  <label for="radio3"> 2 </label>
                </div>
                <div class="radio">
                  <input type="radio" name="data[urgency_level]" id="radio4" value = "3" <?php if(@$miscellaneous['urgency_level'] == 3){ echo 'checked';} ?> >
            ...
            <div class="col-sm-4">
              ...
              <option value="Open" <?php if(@$miscellaneous['status_b']=='Open'){ echo 'selected';} ?>>Open</option>
                <option value="Closed" <?php if(@$miscellaneous['status_b']=='Closed'){ echo 'selected';} ?>>Closed
                </option>
                <option value="Billing" <?php if(@$miscellaneous['status_b']=='Billing'){ echo 'selected';}?>>Billing
                </option>
                <option value="Cancelled" <?php if(@$miscellaneous['status_b']=='Cancelled'){ echo 'selected';}?>>Cancelled</option>          
                <option value="Ongoing" <?php if(@$miscellaneous['status_b']=='Ongoing'){ echo 'selected';} ?>>Ongoing</option>         
                <option value="Personal" <?php if(@$miscellaneous['status_b']=='Personal'){ echo 'selected';} ?>>Personal</option>
              </select>              
            </div>
            ...
            <div class="col-sm-9">
              <textarea class="form-control" type="text" name="data[note]" placeholder="Enter Description" ><?php echo @$miscellaneous['note']?></textarea>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label" for="textinput">Description:</label>
            <div class="col-sm-9">
              <textarea class="form-control" type="text" name="data[description]" placeholder="Enter Description" ><?php echo @$miscellaneous['description']?></textarea>
            </div>
          </div>
          ...
          <button  class="add-save btn btn-primary waves-effect waves-light insert_miscellaneous">Save</button>
          <a  href ="<?=base_url()?>admin/miscellaneous" class="add-save btn btn-primary waves-effect waves-light">Cancle</a>
          </div>
          </div>  
          ...
          <input type="hidden" name="data[id]" value="<?=@$miscellaneous['id']?>">
  ...
  <script>  
    ...
    $(document).on('change','#from_date',function(){
      ...
      $("#insert_miscellaneous").validate({       
        ...
        $('.insert_miscellaneous').click(function(){ 
          var validator = $("#insert_miscellaneous").validate();
            validator.form();
    ...
    function(){                
            ...
            $('.insert_miscellaneous').html("<img src='<?php echo base_url()?>assets/images/ajax-loaderr.gif' style='width:20px; height:15px;'>"); 
              var data = new FormData($('#insert_miscellaneous')[0]);  
                $.ajax({                
                    ...
                    success: function(result){
                        console.log(result);
                        window.location = '<?php echo base_url('admin/miscellaneous');?>';
                       //location.reload();
                    }
    ...
    function supplier_name(val)
    {
      //alert(val);
         $.ajax({
                  ...
                  data: {'supplier_name':val,service_type:'MISC'},
                  success: function (data) 
                  {
                        //alert(data);
