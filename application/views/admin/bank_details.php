...
<!-- CONTENT-WRAPPER-->
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header"><h5 class="card-header-text">Bank details </h5><span>
         ...
         <div class="row">
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">        
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="textinput">IBAN<span class="star">*</span></label>
                        <div class="col-sm-9">
                            <input type ="text" class ="form-control" name ="data[IBAN]" value ="<?=$value['IBAN']?>">
                        </div>
                    </div>
         
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="textinput">SWIFT:<span class="star">*</span></label>
                        <div class="col-sm-9">                
                                 <input type ="text" class ="form-control" name ="data[SWIFT]" value ="<?=$value['SWIFT']?>">
                        </div>
                    </div>
          
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="textinput">ACCOUNT :<span class="star">*</span></label>
                        <div class="col-sm-9">                
                                 <input type ="text" class ="form-control" name ="data[ACCOUNT]" value ="<?=$value['ACCOUNT']?>">
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="textinput">ADDRESS :<span class="star">*</span></label>
                        <div class="col-sm-9">                
                                <!-- <input type ="text" class ="form-control" name ="data[ACCOUNT]" value ="<?=$value['ADDRESS']?>">-->
                                <textarea name ="data[ADDRESS]" class ="form-control"><?=$value['ADDRESS']?></textarea>
                        </div>
                    </div>
