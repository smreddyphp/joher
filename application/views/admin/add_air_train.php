...
<style>
    #insert_train label.error {
        color:red; 
    }
    #insert_train input.error,textarea.error,select.error {
      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-block addform-block">
			<form id="insert_train" method="post" >
         <!-- Form Name -->
               ...
               //print_r($client_code);
                     ...
                     <select class="form-control" name="data[client_code]" id="get_client_code" onchange = "client_code(this.value)">
                        ...
                        <?php 
                            ...
                            { 
                                foreach($res as $row)
                                { ?>
                                 <option value = "<?=$row->client_code?>"  <?php if($row->client_code == @$train['client_code']){ echo 'selected';}else{ echo 'selected';}?> ><?=$row->client_code?></option>   
                            <?php  }
                            } ?>
                ...
                <?php 
                    ...
                    if($res){ 
                        foreach($res as $row)
                        { ?>
                         <option value = "<?=$row->client_code?>"  <?php if($row->client_code == @$train['client_code']){ echo 'selected';}?> ><?=$row->client_code?></option>   
                    <?php  }
                    }
                ?>
            </select>
    ...
    <div class="form-group">
            ...
            <select class="form-control" name="data[trip_id]"  id="get_trip_id">
                    ...
                    <?php 
                        ...
                        { 
                            foreach($res as $row)
                            { ?>
                                <option value = "<?=$row->id?>"  <?php if($row->id == @$train['trip_id']){ echo 'selected';}else if($row->id == $this->uri->segment(5)){ echo 'selected'; } ?> ><?=$row->id?></option> 
                        <?php  }
                        } ?>
            </select>
	    </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="data[client_name]" id="get_client_name" >
                ...
                <?php 
                    ...
                    if($res){ 
                        foreach($res as $row)
                        { ?>
                         <option value ="<?=$row->user_name?>" <?php if($row->user_id == @$train['user_id']){ echo 'selected';}else if($row->user_id==@$client_code['user_id']){ echo 'selected';}?>><?=$row->user_name?></option>   
                    <?php  }
                    }
                ?>
            </select>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
                <?php //echo @$train['service_type'];?>
              <select name="data[service_type]" id="" class="form-control" onchange="myFunction1(this.value)">
              <option value="">Select Service Type</option>
              <option value="Air" <?php if(@$train['service_type']==='Air'){ echo 'selected';} ?> >Air</option>
              <option value="Train" <?php if(@$train['service_type']=='Train'){ echo 'selected';} ?> >Train</option>
              </select>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <?php 
                    $res = $this->db->get_where('suppliers',array('service_type'=>'AIR TICKET'))->result();
                    if($res){ 
                        foreach($res as $row)
                        { ?>
                         <option value = "<?=$row->supplier_code?>"  <?php if($row->supplier_code == @$train['supplier_code']){ echo 'selected';}?> ><?=$row->supplier_code?></option>   
                    <?php  }
                    }
                ?>
            </select>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              ...
              <select class="form-control" name="data[supplier_name]" id="get_supplier_name" 
              onchange = "supplier_name(this.value)">
               ...
               if($res){ 
                foreach($res as $row)
                  { ?>
                   <option value = "<?=@$row->supplier_name?>" <?php if(@$row->supplier_name == @$train['supplier_name']){ echo 'selected';}?>><?=@$row->supplier_name?></option>   
                 <?php  }
               }
               ?>
             </select>
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label" for="textinput">Passenger Name:</label>
            <div class="col-sm-9">
              <input class="form-control" type="text" name="data[passener_name]" value="<?php echo @$train['passener_name']?>" placeholder="Enter Passenger Name" >
            </div>
 			</div>

      <div class="form-group">
            <label class="col-sm-3 control-label" for="textinput">Seat Class:</label>
           
            <div class="col-sm-9">
              <?php if(@$train['seat_class'] ==''){
              ?>
                <select class="form-control" name="data[seat_class]">
                <?php
                    
              foreach($class_type as $key=>$value)
                  {?>
                   <option value="<?php echo $value['id'];?>"><?php echo $value['class_type'];?></option>
                       <?php  } 
         ...
         <?php
              ...
              foreach($class_type as $key=>$value)
                  {
                    if($value['id'] == @$train['seat_class'])
                    {

                    ?>
                   <option value="<?php echo $value['id'];?>" selected><?php echo $value['class_type'];?></option>
                 <?php } else{?>
                  <option value="<?php echo $value['id'];?>"><?php echo $value['class_type'];?></option>
            ...
            <div class="col-sm-9">
            <input class="form-control" type="text" name="data[confirmation_no]" value="<?php echo @$train['confirmation_no']?>" placeholder="Enter Confirmation Number" >
            </div>
          </div>
		  ...
		  <!-- Text input-->
            ...
            <div class="col-sm-9">
              ...
              <option value="ONLINE" <?php if(@$train['payment_method']=='ONLINE'){ echo 'selected';} ?>>ONLINE</option>
              <option value="CREDIT_CARD" <?php if(@$train['payment_method']=='CREDIT_CARD'){ echo 'selected';} ?>>CREDIT CARD</option>
              <option value="DEBIT_CARD" <?php if(@$train['payment_method']=='DEBIT_CARD'){ echo 'selected';} ?>>DEBIT CARD</option>
              <option value="CASH"<?php if(@$train['payment_method']=='CASH'){echo 'selected';} ?>>CASH</option>
              <option value="TBA"<?php if(@$train['payment_method']=='TBA'){echo 'selected';} ?>>TBA</option>
              </select>
            </div>
          </div>
          <div class="form-group ">
            <label class="col-sm-3 control-label" for="textinput">Airline/Train:</label>
            <div class="col-sm-9">
             <span id = "service_type1">
                 <input class="form-control" type="text" name="data[train]" value="<?php echo @$train['train']?>" placeholder="Enter {{ service_type1 }} Name" >
             </span>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label" for="textinput">Ticket Number:</label>
            <div class="col-sm-9">
             <input class="form-control" type="text" name="data[ticket_num]" value="<?php echo @$train['ticket_num']?>" placeholder="Enter Ticket Number" >
            </div>
          </div>

            <div class="form-group">
                <?php //echo @$train['route']?>
                <label class="col-sm-3 control-label" for="textinput">Route:</label>
                <div class="col-sm-7">
                <!-- <input type="text"   placeholder="" name="data1[route][]" value="<?php echo @$train['route']?>" class="form-control col-sm-6" style="width: 280px">-->
                 <select class="form-control" name="data1[route][]"  class="form-control col-sm-6">
                     <option value = "">Select Name</option>
                        <?php 
                        ...
                        { 
                            ...
                            { 
                                ?>
                              <option value ="<?=$row->city_name?>" <?php if($row->city_name == @$train['route']){ echo "selected";} ?> ><?=$row->city_name?></option>
                           <?php  
                         }
                        } ?>
                    </select>
                </div>
                <div class="form-group col-sm-1" style="align-right: "> <button class="btn btn-sm btn-primary add_more_button"><i class="fa fa-plus"></i></button></div>
             </div>
...
<div class="input_fields_container1"> 
 ...
 <?php 
        if(@$train['route'])
        {
            $value = explode(',',ltrim(@$train['route'],','));
            for($i=0;$i<count($value);$i++)
            {
 ?>
   <div class="form-group">
    	<div class="form-group col-md-3"><label class="form-control-label"></label></div> 
    		...
    		<select class="form-control" name="data1[route][]"  class="form-control col-sm-6">
                <option value = "">Select Name</option>
                    ...
                    { 
                        ...
                        { 
                            ?>
                          <option value ="<?=$row->city_name?>" <?php if($row->city_name == $value[$i]){ echo "selected";} ?> ><?=$row->city_name?></option>
                       <?php  
                     }
                    } ?>
            </select>
    	</div>
    	<div class="form-group col-md-3"><a href="#" class="remove_field" style="margin-left:10px;">Remove</a></div>
    </div>
    ...
    <?php } } ?>
            ...
            <div class="input_fields_container"></div>
                ...
                <input type="hidden" name="data[id]" value="<?=@$train[0]['id']?>">                            
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-9">
              <input class="form-control" type="date" name="data[from]" value="<?php echo @$train['from']?>"  placeholder="Enter Depature Date" > 
            </div>
          </div>

          <div class="form-group ">
            <label class="col-sm-3 control-label" for="textinput">Arrival/Return Date:</label>
            <div class="col-sm-9">
              <input class="form-control" type="date" name="data[to]" value="<?php echo @$train['to']?>" placeholder="Enter Arrival Date" >             
            </div>
          </div>
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-9">
            <input class="form-control" type="time" name="data[departure_time]" value="<?php echo @$train['departure_time']?>" placeholder="Enter Depature Time" >             
            </div>
          </div>
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-9">
            <input class="form-control" type="time" name="data[arrival_time]" value="<?php echo @$train['arrival_time']?>" placeholder="Enter Arrival Time" >              
            </div>
          </div>

            <div class="form-group ">
            <label class="col-sm-3 control-label" for="textinput">Supplier Inv No:</label>
            <div class="col-sm-9">
            <input class="form-control" type="text" name="data[supplier_no]" value="<?php echo @$train['supplier_no']?>" placeholder="Enter Supplier Inv No" >  
            </div>
          </div>          
            ...
            <div class="col-sm-9">
            <input class="form-control" type="text" name="data[final_invoice_no]" value="<?php echo @$train['final_invoice_no']?>" placeholder="Enter Final Invoice No" >              
            </div>
          </div>
            ...
            <div class="col-sm-9">
            <input class="form-control" type="text" name="data[invoice_no]" value="<?php echo @$train['invoice_no']?>" placeholder="Enter Invoice No" >              
            </div>
          </div>
    ...
    <span onclick="myFunction()">    
                        ...
                        <div class="col-sm-2">
                            <select name="data[frc]" name="data[frc]" id="fcrCode" class="form-control wi">
                                ...
                                <?php 
                                    ...
                                    { ?>
                                         <option value = "<?php echo @$row2['id']?>" <?php if($row2['id'] == @$train['frc']){ echo "selected";} ?> ><?=@$row2['country_code']?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <label class="col-sm-2 control-label text-center" for="textinput">Buy FOREX:</label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[buy_forex]" id = "buy_forex" value = "<?php echo @$train['buy_forex']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput">Sell FOREX:</label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[sel_forex]" id = "sel_forex" value = "<?php echo @$train['sel_forex']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[supplier_base_rate]" id = "supplier_base_rate" value = "<?php echo @$train['supplier_base_rate']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_base_rate_buy]" id = "supplier_base_rate_buy" value = "<?php echo @$train['supplier_base_rate_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_base_rate_sel]" id = "supplier_base_rate_sel" value = "<?php echo @$train['supplier_base_rate_sel']?>" class="form-control wi">  
                        </div>
                    </div>          
                </div>
        </div> 
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[total_supplier_base_rate]" id = "total_supplier_base_rate" value = "<?php echo @$train['total_supplier_base_rate']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_supplier_base_rate_buy]" id = "total_supplier_base_rate_buy" value = "<?php echo @$train['total_supplier_base_rate_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_supplier_base_rate_sel]" id = "total_supplier_base_rate_sel" value = "<?php echo @$train['total_supplier_base_rate_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[supplier_tax]" id = "supplier_tax" value = "<?php echo @$train['supplier_tax']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_tax_buy]" id = "supplier_tax_buy" value = "<?php echo @$train['supplier_tax_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_tax_sel]" id = "supplier_tax_sel" value = "<?php echo @$train['supplier_tax_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[other_fees]" id = "other_fees" value = "<?php echo (@$train['other_fees'])?@$train['other_fees']:'0.00'?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[other_fees_buy]" id = "other_fees_buy" value = "<?php echo (@$train['other_fees_buy'])?@$train['other_fees_buy']:'0.00'?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[other_fees_sel]" id = "other_fees_sel" value = "<?php echo (@$train['other_fees_sel'])?@$train['other_fees_sel']:'0.00'?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[supplier_total]" id = "supplier_total" value = "<?php echo @$train['supplier_total']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_total_buy]" id = "supplier_total_buy" value = "<?php echo @$train['supplier_total_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_total_sel]" id = "supplier_total_sel" value = "<?php echo @$train['supplier_total_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[actual_supplier_total]" id = "actual_supplier_total" value = "<?php echo @$train['actual_supplier_total']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[actual_supplier_total_buy]" id = "actual_supplier_total_buy" value = "<?php echo @$train['actual_supplier_total_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[actual_supplier_total_sel]" id = "actual_supplier_total_sel" value = "<?php echo @$train['actual_supplier_total_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[commission1]" id = "commission1" value = "<?php echo @$train['commission1']?>" class="form-control wi">
                        </div>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[commission_per]" id = "commission_per" value = "<?php echo @$train['commission_per']?>" class="form-control " placeholder="%">%  
                        </div>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[commission_buy]" id = "commission_buy" value = "<?php echo @$train['commission_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[commission_sel]" id = "commission_sel" value = "<?php echo @$train['commission_sel']?>" class="form-control wi">  
                        </div>
                    </div>          
                </div>
         </div>  
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[markup1]" id = "markup1" value = "<?php echo @$train['markup1']?>" class="form-control wi">
                        </div>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[markup_per]" id = "markup_per" value = "<?php echo @$train['markup_per']?>" class="form-control" placeholder="%">%  
                        </div>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[markup_buy]" id = "markup_buy" value = "<?php echo @$train['markup_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[markup_sel]" id = "markup_sel" value = "<?php echo @$train['markup_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[total_wo_vat]" id = "total_wo_vat" value = "<?php echo @$train['total_wo_vat']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_wo_vat_buy]" id = "total_wo_vat_buy" value = "<?php echo @$train['total_wo_vat_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_wo_vat_sel]" id = "total_wo_vat_sel" value = "<?php echo @$train['total_wo_vat_sel']?>" class="form-control wi">  
                        </div>
                    </div>          
                </div>
          </div>  
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[vat_commission]" id = "vat_commission" value = "<?php echo @$train['vat_commission']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_commission_buy]" id = "vat_commission_buy" value = "<?php echo @$train['vat_commission_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_commission_sel]" id = "vat_commission_sel" value = "<?php echo @$train['vat_commission_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[vat_markup]" id = "vat_markup" value = "<?php echo @$train['vat_markup']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_markup_buy]" id = "vat_markup_buy" value = "<?php echo @$train['vat_markup_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_markup_sel]" id = "vat_markup_sel" value = "<?php echo @$train['vat_markup_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[vat_forex]" id = "vat_forex" value = "<?php echo (@$train['vat_forex'])?@$train['vat_forex']:'0.00'?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_forex_buy]" id = "vat_forex_buy" value = "<?php echo (@$train['vat_forex_buy'])?@$train['vat_forex_buy']:'0.00'?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_forex_sel]" id = "vat_forex_sel" value = "<?php echo (@$train['vat_forex_sel'])?@$train['vat_forex_sel']:'0.00'?>" class="form-control wi">  
                        </div>
                    </div>          
                </div>
          </div>  
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[total_w_vat]" id = "total_w_vat" value = "<?php echo @$train['total_w_vat']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_w_vat_buy]" id = "total_w_vat_buy" value = "<?php echo @$train['total_w_vat_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_w_vat_sel]" id = "total_w_vat_sel" value = "<?php echo @$train['total_w_vat_sel']?>" class="form-control wi">  
                        </div>
                     </div>          
                </div>
          </div>  
        ...
        <div class="form-group ">
          ...
          <div class="col-md-12">
           ...
           <div class="col-sm-3">
             <div class="radio">
            <input type="radio" name="data[urgency_level]"  <?php if(@$train['urgency_level'] == 0){ echo 'checked';} ?> id="radio1" value = "1">
            <label for="radio1">
                0
            </label>
        </div>
        <div class="radio">
            <input type="radio" name="data[urgency_level]" id="radio2" value = "1" <?php if(@$train['urgency_level'] == 1){ echo 'checked';} ?>>
            <label for="radio2">
                1
            </label>
        </div>
        <div class="radio">
            <input type="radio" name="data[urgency_level]" id="radio3" value = "2" <?php if(@$train['urgency_level'] == 2){ echo 'checked';} ?> >
            <label for="radio3">
                2
            </label>
        </div>
        <div class="radio">
            <input type="radio" name="data[urgency_level]" id="radio4" value = "3" <?php if(@$train['urgency_level'] == 3){ echo 'checked';} ?> >
            <label for="radio4">
               3
            </label>
        </div>              
            ...
            <option value="Open" <?php if(@$train['status_b']=='Open'){ echo 'selected';} ?>>Open</option>
            <option value="Closed" <?php if(@$train['status_b']=='Closed'){ echo 'selected';} ?>>Closed
            </option>
            <option value="Billing" <?php if(@$train['status_b']=='Billing'){ echo 'selected';}?>>Billing
            </option>
            <option value="Cancelled" <?php if(@$train['status_b']=='Cancelled'){ echo 'selected';}?>>Cancelled</option>          
            <option value="Ongoing" <?php if(@$train['status_b']=='Ongoing'){ echo 'selected';} ?>>Ongoing</option>         
            <option value="Personal" <?php if(@$train['status_b']=='Personal'){ echo 'selected';} ?>>Personal</option>
            </select>
            ...
            <div class="col-sm-9">
              <textarea class="form-control" type="text" name="data[note]" placeholder="Enter Description" ><?php echo @$train['note']?></textarea>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label" for="textinput">Description:</label>
            <div class="col-sm-9">
              <textarea class="form-control" type="text" name="data[description]" placeholder="Enter Description" ><?php echo @$train['description']?></textarea>
            </div>
          </div>
          ...
          <!--<button class="add-save btn btn-md">Save</button>-->
           <button  class="add-save btn btn-primary waves-effect waves-light insert_train">Save</button>
          ...
          <div class="col-md-6 cost_box">
           ...
           <input type="hidden" name="data[id]" value="<?=@$train['id']?>">    
    ...
    //$('#tot_sale_cost').val(tot_cal); 
      $("#insert_train").validate({       
            rules: {
              ...
              "data[passener_name]"        : "required",
              "data[seat_class]"           : "required",
              "data[confirmation_no]"      : "required",
              "data[payment_method]"       : "required",
              "data[train]"                : "required",
              "data[ticket_num]"           : "required",
              "data[route]"                : "required",
              "data[departure_date]"       : "required",
              "data[arrival_date]"         : "required",
              "data[departure_time]"       : "required",
              "data[arrival_time]"         : "required",
              "data[supplier_no]"          : "required",
        ...
        $('.insert_train').click(function(){ 
          var validator = $("#insert_train").validate();
            validator.form();
        ...
        function(){                
            ...
            $('.insert_train').html("<img src='<?php echo base_url()?>assets/images/ajax-loaderr.gif' style='width:20px; height:15px;'>"); 
              var data = new FormData($('#insert_train')[0]);  
                $.ajax({                
   ...
   <script>
    function supplier_code(val)
    {
         $.ajax({
                  ...
                  data: {'id':val,service_type:'AIR TICKET'},
    ...
    function supplier_name(val)
    {
      //alert(val);
         $.ajax({
                  ...
                  data: {'supplier_name':val,service_type:'AIR TICKET'},
                  success: function (data) 
                  {
                        //alert(data);
...
<script>
    function myFunction1(value) 
    {
        if(value == 'Air')
        {
            $('#service_type1').html('<input class="form-control" type="text" name="data[train]" value="<?php echo @$train['train']?>" placeholder="Enter '+value+' Name" >');
        }
        else if(value == 'Train')
        {
             $('#service_type1').html('<input class="form-control" type="text" name="data[train]" value="<?php echo @$train['train']?>" placeholder="Enter '+value+' Name" >');
