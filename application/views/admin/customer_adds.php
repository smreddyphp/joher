<!-- CONTENT-WRAPPER-->
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header"><h5 class="card-header-text">Add/Edit <?php echo @$page_name; ?></h5><span><button class="btn btn-success fa fa-plus add_adds" data-name="<?php echo @$current_page; ?>" style="margin-left:65%">Add </button></span></div>
  ...
  <section>
   ...
   <script>     
        ...
        $('.add_adds').on('click',function(event){ 
            ...
            $modal.load('<?php echo site_url('admin/add_adds');?>', {id: id,pname:pname},
            function(){
            /*$('.modal').replaceWith('');*/
            $modal.modal('show');
