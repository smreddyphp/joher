<style>
    #insert_aircraft label.error {
        color:red; 
    }
    #insert_aircraft input.error,textarea.error,select.error {
      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-block addform-block">
			<form id="insert_aircraft" method="post" >
         <!-- Form Name -->
               ...
               //print_r($client_code);
                     ...
                     onchange = "client_code(this.value)">
                        ...
                        <?php 
                            ...
                            { 
                                foreach($res as $row)
                                { ?>
                                 <option value = "<?=$row->client_code?>"  <?php if($row->client_code == @$craft['client_code']){ echo 'selected';}else{ echo 'selected';}?> ><?=$row->client_code?></option>   
                            <?php  }
                            }
                        ?>
                ...
                <?php 
                    ...
                    if($res){ 
                        foreach($res as $row)
                        { ?>
                         <option value = "<?=$row->client_code?>"  <?php if($row->client_code == @$craft['client_code']){ echo 'selected';}?> ><?=$row->client_code?></option>   
                    <?php  }
                    }
                ?>
            </select>
                ...
                <select class="form-control" name="data[trip_id]"  id="get_trip_id">
                        ...
                        <?php 
                            ...
                            { 
                                foreach($res as $row)
                                { ?>
                                    <option value = "<?=$row->id?>"  <?php if($row->id == @$craft['trip_id']){ echo 'selected';}else if($row->id == $this->uri->segment(5)){ echo 'selected'; } ?> ><?=$row->id?></option> 
                            <?php  }
                            } ?>
                </select>
    	    </div>
            ...
            <select class="form-control" name="data[client_name]" id="get_client_name" >
                ...
                <?php 
                    ...
                    if($res){ 
                        foreach($res as $row)
                        { ?>
                         <option value ="<?=$row->user_name?>" <?php if($row->user_id == @$craft['user_id']){ echo 'selected';}else if($row->user_id==@$client_code['user_id']){ echo 'selected';}?>><?=$row->user_name?></option>   
                    <?php  }
                    }
                ?>
            </select>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
              ...
              <option value="Aircraft" <?php if(@$craft['service_type']=='Aircraft'){ echo 'selected';} ?>>Air Craft</option>
              </select>
            </div>
          </div>         
         ...
         <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <?php 
                    $res = $this->db->get_where('suppliers',array('service_type'=>'PRIVATE JET'))->result();
                    if($res){ 
                        foreach($res as $row)
                        { ?>
                         <option value = "<?=$row->supplier_code?>"  <?php if($row->supplier_code == @$craft['supplier_code']){ echo 'selected';}?> ><?=$row->supplier_code?></option>   
                    <?php  }
                    }
                ?>
            </select>
         ...
         <div class="form-group">
            ...
            <select class="form-control" name="data[supplier_name]" id="get_supplier_name" onchange = "supplier_name(this.value)" >
                ...
                <?php 
                    ...
                    if($res){ 
                        foreach($res as $row)
                        { ?>
                         <option value ="<?=$row->supplier_name?>" <?php if($row->supplier_name == @$craft['supplier_name']){ echo 'selected';}?>><?=$row->supplier_name?></option>   
                    <?php  }
                    }
                ?>
            </select>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
             <input class="form-control" type="text" name="data[guest_name]" value="<?php echo @$craft['guest_name']?>" placeholder="Enter Guest Name" >
            </div>
 			  </div>
            ...
            <div class="col-sm-9">
             <input class="form-control" type="text" name="data[confirmation_no]" value="<?php echo @$craft['confirmation_no']?>" placeholder="Enter Confirmation Number" >
            </div>
          </div>
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-9">
              ...
              <option value="ONLINE" <?php if(@$craft['payment_method']=='ONLINE'){ echo 'selected';} ?>>ONLINE</option>
              <option value="CREDIT_CARD" <?php if(@$craft['payment_method']=='CREDIT_CARD'){ echo 'selected';} ?>>CREDIT CARD</option>
              <option value="DEBIT_CARD" <?php if(@$craft['payment_method']=='DEBIT_CARD'){ echo 'selected';} ?>>DEBIT CARD</option>
              <option value="CASH"<?php if(@$craft['payment_method']=='CASH'){echo 'selected';} ?>>CASH</option>
              <option value="TBA"<?php if(@$craft['payment_method']=='TBA'){echo 'selected';} ?>>TBA</option>
              </select>
            </div>
          </div> 

          <div class="form-group ">
            <label class="col-sm-3 control-label" for="textinput">Aircraft Type:</label>
            <div class="col-sm-9">
            <input class="form-control" type="text" name="data[aircraft_type]" value="<?php echo @$craft['aircraft_type']?>" placeholder="Enter Aircraft Name" >
            </div>
          </div>

          <div class="form-group">
            <label class="col-sm-3 control-label" for="textinput">Aircraft Tail No:</label>
            <div class="col-sm-9">
                <input class="form-control" type="text" name="data[aircraft_tail_no]" value="<?php echo @$craft['aircraft_tail_no']?>" placeholder="Enter Aircraft No" >
            </div>
          </div>
            ...
            <div class="form-group">
               ...
               <?php 
                    ...
                    if(@$craft['route'])
                    {
                        ...
                        ?>
                        <select class="form-control" name="data1[route][]">
                             <?php
                                foreach($res as $row)
                                { 
                    ...
                    <?php } }else{  ?>
                            ...
                            <select class="form-control" name="data1[route][]">
                                ...
                                <?php 
                                    ...
                                    foreach($res as $row)
                                    { ?>
                                        <option value ="<?=$row->city_name?>" <?php if($row->city_name== @$craft['route']){ echo 'selected';}?> ><?=$row->city_name?></option>
                                        <?php  
                                    }
                                }   ?>
                                </select>
                            <a class="form-group col-md-1" href="#" class="place" data-text="<?php echo @$city;?>" style="margin-left:5px;">Remove</a>
                    <?php } ?>
                </div>
             ...
             <div class="form-group ">
                  <label class="col-sm-3 control-label" for="textinput">Cities<span class="star">*</span></label>
                <div class="col-sm-9">
                  <div class="col-sm-9">
                 <!--<input type="text" placeholder="" name="data1[route][]" value="<?php //echo @$trip['intermediate_cities']?>" class="form-control"> -->
                            ...
                            <div class="input_fields_container1">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group">
                                                <!--<a href="#" class="remove_field" data-text="<?php echo @$city;?>" style="margin-left:5px;">Remove</a>-->
                                                <a href="#" class="remove_field" data-text="<?php echo @$city;?>" style="margin-left:10px;">Remove</a>
                                            </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-9">
                    <input type="date" name="data[from]" value="<?php if(@$craft['from']){ echo date('Y-m-d',strtotime(@$craft['from'])); } ?>" class="form-control">
                </div>
            </div>
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-9">
            <input type="date" name="data[to]" value="<?php if(@$craft['to']){ echo date('Y-m-d',strtotime(@$craft['to'])); }?>" class="form-control">
              </select>
            </div>
          </div>
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-9">
            <input class="form-control" type="time" name="data[departure_time]" value="<?php echo @$craft['departure_time']?>" placeholder="Enter Depature Time" >
            </div>
          </div> 
           ...
           <div class="form-group ">
            ...
            <div class="col-sm-9">
            <input class="form-control" type="time" name="data[arrival_time]" value="<?php echo @$craft['arrival_time']?>" placeholder="Enter Arrival Time" >
            </div>
          </div>
          <div class="form-group ">
            <label class="col-sm-3 control-label" for="textinput">Supplier Inv No:</label>
            <div class="col-sm-9">
            <input class="form-control" type="text" name="data[supplier_no]" value="<?php echo @$craft['supplier_no']?>" placeholder="Enter Supplier Inv No" >
              </select>
            </div>
          </div>          
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-9">
            <input class="form-control" type="text" name="data[final_invoice_no]" value="<?php echo @$craft['final_invoice_no']?>" placeholder="Enter Final Invoice No" >
              </select>
            </div>
          </div>
          <div class="form-group ">
            ...
            <div class="col-sm-9">
            <input class="form-control" type="text" name="data[invoice_no]" value="<?php echo @$craft['invoice_no']?>" placeholder="Enter Invoice No" >
              </select>
            </div>
          </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <select name="data[fcr]" name="data[fcr]" id="fcrCode" class="form-control wi">
                                ...
                                <?php 
                                    ...
                                    { ?>
                                         <option value = "<?php echo @$row2['id']?>" <?php if($row2['id'] == @$craft['fcr']){ echo "selected";} ?> ><?=@$row2['country_code']?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <label class="col-sm-2 control-label text-center" for="textinput">Buy FOREX:</label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[buy_forex]" id = "buy_forex" value = "<?php echo @$craft['buy_forex']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput">Sell FOREX:</label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[sel_forex]" id = "sel_forex" value = "<?php echo @$craft['sel_forex']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[supplier_base_rate]" id = "supplier_base_rate" value = "<?php echo @$craft['supplier_base_rate']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_base_rate_buy]" id = "supplier_base_rate_buy" value = "<?php echo @$craft['supplier_base_rate_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_base_rate_sel]" id = "supplier_base_rate_sel" value = "<?php echo @$craft['supplier_base_rate_sel']?>" class="form-control wi">  
                        </div>
                    </div>          
                </div>
        </div> 
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[total_supplier_base_rate]" id = "total_supplier_base_rate" value = "<?php echo @$craft['total_supplier_base_rate']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_supplier_base_rate_buy]" id = "total_supplier_base_rate_buy" value = "<?php echo @$craft['total_supplier_base_rate_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_supplier_base_rate_sel]" id = "total_supplier_base_rate_sel" value = "<?php echo @$craft['total_supplier_base_rate_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[supplier_tax]" id = "supplier_tax" value = "<?php echo @$craft['supplier_tax']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_tax_buy]" id = "supplier_tax_buy" value = "<?php echo @$craft['supplier_tax_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_tax_sel]" id = "supplier_tax_sel" value = "<?php echo @$craft['supplier_tax_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[other_fees]" id = "other_fees" value = "<?php echo (@$craft['other_fees'])?@$craft['other_fees']:'0.00'?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[other_fees_buy]" id = "other_fees_buy" value = "<?php echo (@$craft['other_fees_buy'])?@$craft['other_fees_buy']:'0.00'?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[other_fees_sel]" id = "other_fees_sel" value = "<?php echo (@$craft['other_fees_sel'])?@$craft['other_fees_sel']:'0.00'?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[supplier_total]" id = "supplier_total" value = "<?php echo @$craft['supplier_total']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_total_buy]" id = "supplier_total_buy" value = "<?php echo @$craft['supplier_total_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[supplier_total_sel]" id = "supplier_total_sel" value = "<?php echo @$craft['supplier_total_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[actual_supplier_total]" id = "actual_supplier_total" value = "<?php echo @$craft['actual_supplier_total']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[actual_supplier_total_buy]" id = "actual_supplier_total_buy" value = "<?php echo @$craft['actual_supplier_total_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[actual_supplier_total_sel]" id = "actual_supplier_total_sel" value = "<?php echo @$craft['actual_supplier_total_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[commission1]" id = "commission1" value = "<?php echo @$craft['commission1']?>" class="form-control wi">
                        </div>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[commission_per]" id = "commission_per" value = "<?php echo @$craft['commission_per']?>" class="form-control " placeholder="%">%  
                        </div>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[commission_buy]" id = "commission_buy" value = "<?php echo @$craft['commission_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[commission_sel]" id = "commission_sel" value = "<?php echo @$craft['commission_sel']?>" class="form-control wi">  
                        </div>
                    </div>          
                </div>
         </div>  
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[markup1]" id = "markup1" value = "<?php echo @$craft['markup1']?>" class="form-control wi">
                        </div>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[markup_per]" id = "markup_per" value = "<?php echo @$craft['markup_per']?>" class="form-control" placeholder="%">%  
                        </div>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[markup_buy]" id = "markup_buy" value = "<?php echo @$craft['markup_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[markup_sel]" id = "markup_sel" value = "<?php echo @$craft['markup_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[total_wo_vat]" id = "total_wo_vat" value = "<?php echo @$craft['total_wo_vat']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_wo_vat_buy]" id = "total_wo_vat_buy" value = "<?php echo @$craft['total_wo_vat_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_wo_vat_sel]" id = "total_wo_vat_sel" value = "<?php echo @$craft['total_wo_vat_sel']?>" class="form-control wi">  
                        </div>
                    </div>          
                </div>
          </div>  
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[vat_commission]" id = "vat_commission" value = "<?php echo @$craft['vat_commission']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_commission_buy]" id = "vat_commission_buy" value = "<?php echo @$craft['vat_commission_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_commission_sel]" id = "vat_commission_sel" value = "<?php echo @$craft['vat_commission_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[vat_markup]" id = "vat_markup" value = "<?php echo @$craft['vat_markup']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_markup_buy]" id = "vat_markup_buy" value = "<?php echo @$craft['vat_markup_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_markup_sel]" id = "vat_markup_sel" value = "<?php echo @$craft['vat_markup_sel']?>" class="form-control wi">  
                        </div>
        ...
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[vat_forex]" id = "vat_forex" value = "<?php echo (@$craft['vat_forex'])?@$craft['vat_forex']:'0.00'?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_forex_buy]" id = "vat_forex_buy" value = "<?php echo (@$craft['vat_forex_buy'])?@$craft['vat_forex_buy']:'0.00'?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[vat_forex_sel]" id = "vat_forex_sel" value = "<?php echo (@$craft['vat_forex_sel'])?@$craft['vat_forex_sel']:'0.00'?>" class="form-control wi">  
                        </div>
                    </div>          
                </div>
          </div>  
        <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2">
                            <input type = "text" name="data[total_w_vat]" id = "total_w_vat" value = "<?php echo @$craft['total_w_vat']?>" class="form-control wi">
                        </div>
                         <label class="col-sm-2 control-label text-center" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_w_vat_buy]" id = "total_w_vat_buy" value = "<?php echo @$craft['total_w_vat_buy']?>" class="form-control wi">  
                        </div>
                        <label class="col-sm-2 control-label" for="textinput"></label>
                        <div class="col-sm-2">            
                            <input type = "text" name="data[total_w_vat_sel]" id = "total_w_vat_sel" value = "<?php echo @$craft['total_w_vat_sel']?>" class="form-control wi">  
                        </div>
                     </div>          
                </div>
          </div>  
        ...
        <div class="form-group "><div class="row"><hr/></div></div>
         ...
         <div class="form-group ">
          ...
          <div class="col-md-12">
           ...
           <div class="col-sm-3">
             <div class="radio">
            <input type="radio" name="data[urgency_level]"  <?php if(@$craft['urgency_level'] == 0){ echo 'checked';} ?> id="radio1" value = "1">
            <label for="radio1">
                0
            </label>
        </div>
        <div class="radio">
            <input type="radio" name="data[urgency_level]" id="radio2" value = "1" <?php if(@$craft['urgency_level'] == 1){ echo 'checked';} ?>>
            <label for="radio2">
                1
            </label>
        </div>
        <div class="radio">
            <input type="radio" name="data[urgency_level]" id="radio3" value = "2" <?php if(@$craft['urgency_level'] == 2){ echo 'checked';} ?> >
            <label for="radio3">
                2
            </label>
        </div>
        <div class="radio">
            <input type="radio" name="data[urgency_level]" id="radio4" value = "3" <?php if(@$craft['urgency_level'] == 3){ echo 'checked';} ?> >
            <label for="radio4">
               3
            </label>
        </div>
            ...
            <!-- <option value="Processing" <?php if(@$craft['status_b']=='Processing'){ echo 'selected';} ?>>Processing</option> -->
            <option value="Open" <?php if(@$craft['status_b']=='Open'){ echo 'selected';} ?>>Open</option>
            <option value="Closed" <?php if(@$craft['status_b']=='Closed'){ echo 'selected';} ?>>Closed
            </option>
            <option value="Billing" <?php if(@$craft['status_b']=='Billing'){ echo 'selected';}?>>Billing
            </option>
            <option value="Cancelled" <?php if(@$craft['status_b']=='Cancelled'){ echo 'selected';}?>>Cancelled</option>          
            <option value="Ongoing" <?php if(@$craft['status_b']=='Ongoing'){ echo 'selected';} ?>>Ongoing</option>         
            <option value="Personal" <?php if(@$craft['status_b']=='Personal'){ echo 'selected';} ?>>Personal</option>
            </select>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <textarea class="form-control" type="text" name="data[note]" placeholder="Enter Description" ><?php echo @$craft['note']?></textarea>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label" for="textinput">Description:</label>
            <div class="col-sm-9">
              <textarea class="form-control" type="text" name="data[description]" placeholder="Enter Description" ><?php echo @$craft['description']?></textarea>
            </div>
          </div>
          ...
          <!--<button class="add-save btn btn-md">Save</button>-->
           <button  class="add-save btn btn-primary waves-effect waves-light insert_aircraft">Save</button>
           <a  href ="<?=base_url()?>admin/aircraft" class="add-save btn btn-primary waves-effect waves-light">CANCEL</a>
          ...
          <div class="col-md-6 cost_box">
           ...
           <input type="hidden" name="data[id]" value="<?=@$craft['id']?>">    
    ...
    $(document).on('change','#from_date',function(){
      ...
      $("#insert_aircraft").validate({       
            rules: {
              ...
              "data[aircraft_type]"            : "required",
              "data[aircraft_tail_no]"         : "required",
              "data[route]"                    : "required",
              "data[from]"                     : "required",
              "data[to]"                       : "required",
        ...
        $('.insert_aircraft').click(function(){ 
          var validator = $("#insert_aircraft").validate();
           validator.form();
        ...
        function(){        
            ...
            $('.insert_aircraft').html("<img src='<?php echo base_url()?>assets/images/ajax-loaderr.gif' style='width:20px; height:15px;'>"); 
              var data = new FormData($('#insert_aircraft')[0]);  
                $.ajax({                
                    ...
                    success: function(result){
                        console.log(result);
                        window.location = '<?php echo base_url('admin/aircraft');?>';
                       //location.reload();
                    }
...
<script>
    function supplier_code(val)
    {
         $.ajax({
                  ...
                  data: {'id':val,service_type:'PRIVATE JET'},
    ...
    function supplier_name(val)
    {
      //alert(val);
         $.ajax({
                  ...
                  data: {'supplier_name':val,service_type:'PRIVATE JET'},
                  success: function (data) 
                  {
                        //alert(data);
