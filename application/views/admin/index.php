                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="bg-success dashboard-success">
                        <div class="sales-success">
                            ...
                            <div class="f-right">
                                <h2 class="counter"><?php echo $this->db->where('auth_level',6)->get('users')->num_rows(); ?></h2>
                            </div>
                        </div>
                        <div class="bg-dark-success">
                            <p class="week-sales">Agents</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="bg-warning dasboard-warning">
                        <div class="sales-warning">
                            ...
                            <div class="f-right">
                                <h2 class="counter"><?php echo $this->db->get('category_adds')->num_rows(); ?></h2>
                            </div>
                        </div>
                       <div class="bg-dark-warning">
                            <p class="week-sales">Categories</p>
