...
<div class="modal-dialog" role="document">
    <div class="modal-content" style="overflow:hidden">
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Edit Number</h4>
        </div>
        <div class="modal-body">
            <form id="insert_adds">                         
                
                <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Edit Number</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="text" name="data[number]" value="<?php echo @$value['number']?>" placeholder="Enter Number" >
                    </div>
                </div>
