...
<div class="modal-dialog" role="document">
    <div class="modal-content" style="overflow:hidden">
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Airlines </h4>
        </div>
        <div class="modal-body">
            <form id="insert_adds" method="post">                         
                
                <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Add Airlines</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="text" name="data[airlines_name]" value="<?php echo @$value['airlines_name']?>" placeholder="Enter Airlines" >
                    </div>
                </div>
