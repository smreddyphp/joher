    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-body">
            <form id="insert_adds">                         
                ...
                <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Category Name</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <textarea class="form-control" placeholder="Enter Text" name="data[text_en]" style="height: 100px;"><?php echo @$value['text_en']?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <textarea class="form-control" placeholder="Enter Text in arabic" name="data[text_ar]" style="height: 100px;"><?php echo @$value['text_ar']?></textarea>
