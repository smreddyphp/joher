...
<div class="modal-dialog" role="document">
    <div class="modal-content" style="overflow:hidden">
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Local City </h4>
        </div>
        <div class="modal-body">
            <form id="insert_adds" method="post">                         
                
                <!-- <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Add Country</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Add Local City</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="text" name="data[city_name]" value="<?php echo @$value['city_name']?>" placeholder="Enter City" >
                    </div>
                </div>
