...
class Admin extends CI_Controller 
{
	...
	public function add_Category($value='') 
	{
		...
		if($data['pname']=='local_city')
		{
		    $data['value']  = ($data['id'] != "") ? $this->crms_m->get_local_city($data['id']) : array();
		   // echo $this->db->last_query();
		}
		...
		if($data['pname']=='fcr')
		{
		     $data['value']  = ($data['id'] != "") ? $this->crms_m->get_fcr($data['id']) : array();
		}
		...
		else if($data['pname']=='local_city')
		{
		    $this->load->view('admin/add_local_city',$data);
		}
		...
		else if($data['pname']=='fcr')
		{
		        $this->load->view('admin/add_fcr',$data);
		}
		else
		{
	...
	public function save_client()
		{
	    	...
	    	if(!empty($data['user_id']))
            		...
            		////////Start 11-10-2018/////////////////   
                		if(@$data['parties']){ 
                			$data['parties']         = serialize($data['parties']);
                		}
                		else
                		{
                			$data['parties'] = '';
                		...
                		if(@$data['travel_details']){ 
                			$data['travel_details']         = serialize($data['travel_details']);
                		}
                		else
                		{
                			$data['travel_details'] = '';
                		}
                		if(@$data['local_city_details']){ 
                			$data['local_city_details']         = serialize($data['local_city_details']);
                		}
                		else
                		{
                			$data['local_city_details'] = '';
                		}
                		
                		if(@$data['restaurants']){ 
                			$data['restaurants']         = serialize($data['restaurants']);
                		}
                		else
                		{
                			$data['restaurants'] = '';
                		...
                		if(@$data['shopping']){ 
                			$data['shopping']         = serialize($data['shopping']);
                		}
                		else
                		{
                			$data['shopping'] = '';
                		...
                		if(@$data['prefered_booking']){ 
                			$data['prefered_booking']         = serialize($data['prefered_booking']);
                		}
                		else
                		{
                			$data['prefered_booking'] = '';
                		}

                		if(@$data['seating_preference']!='Others'){ 
                			$data['seat_other']         = '';
                		}
                		if(@$data['meal_preference']!='Others'){ 
                			$data['meal_other']         = '';
                		}

                		if(@$data['special_room']!='Others'){ 
                			$data['special_other']         = '';
                		}
	...
	public function dashboard_index()
	{
		...
		{ 
			if($this->session->userdata('role') =='admin')
			{
				...
				$data['user_info']      = $this->common_m->get_user_details();
				$data['trip_count']     = $this->common_m->trip_count();
				$data['city_count']     = $this->common_m->city_count();
				$data['users_count'] = $this->common_m->users_count();
				$data['graph_trip']     = $this->common_m->get_monthwise_reg1('1');
				//$data['graph_indi']     = $this->common_m->get_monthwise_reg2('2');
				$data['graph_auto']     = $this->common_m->get_monthwise_reg3('3');
				$data['graph_scrap']    = $this->common_m->get_monthwise_reg4('4');
				$data['client_names']   = $this->common_m->get_client_name();
				//$data['status']         = $this->common_m->get_status();
				$data['hotel']         = $this->common_m->get_hotel_count();
				$data['train']         = $this->common_m->get_train_count();
				$data['craft']         = $this->common_m->get_craft_count();
				$data['driver']        = $this->common_m->get_driver_count();
				$data['boat']          = $this->common_m->get_boat_count();
				$data['company']       = $this->common_m->get_company_count();
				$data['cruise']        = $this->common_m->get_cruise_count();
				$data['cargo']         = $this->common_m->get_cargo_count();
				$data['event']         = $this->common_m->get_event_count();
				$data['miscellaneous'] = $this->common_m->get_miscellaneous_count();			

				// For service status

				$data['hotel_status']         = $this->common_m->get_hotel_status();
				$data['train_status']         = $this->common_m->get_train_status();
				$data['craft_status']         = $this->common_m->get_craft_status();
				$data['driver_status']        = $this->common_m->get_driver_status();
				$data['boat_status']          = $this->common_m->get_boat_status();
				$data['company_status']       = $this->common_m->get_company_status();
				$data['cruise_status']        = $this->common_m->get_cruise_status();
				$data['cargo_status']         = $this->common_m->get_cargo_status();
				$data['event_status']         = $this->common_m->get_event_status();
				$data['miscellaneous_status'] = $this->common_m->get_miscellaneous_status();

				$data['trip_names']           = $this->common_m->get_trip_names();
				$data['trip_status']          = $this->common_m->get_trip_status();
	...
	//View Client Details
	public function view_client($value = '')
	{
	    if($this->session->userdata('auth_level')) 
		{ 
			if($this->session->userdata('role') =='admin')
	...
	//View Trip
	public function view_trip($value = '',$id='')
	 {
	    if($this->session->userdata('auth_level')) 
		{ 
			if($this->session->userdata('role') =='admin')
			{
				$data['current_page']   ="view_trip";
				$data['page_name']      ="view_trip";
				$data['user_info']      = $this->common_m->get_user_details();
				$data['cities']      = $this->crms_m->get_cities_details();
				$data['view_trip']          = ($value != "") ? $this->crms_m->get_trip_data($value,$id): array();
				//print_r($data['view_trip']); exit;
				$this->load->view('admin/includes/header',$data);
				$this->load->view('admin/includes/footer');
				$this->load->view('admin/view_trip',$data);
			}
			else
			{
				redirect(base_url().'home/index');
   ...
   <small class="text-muted"><span class="fa fa-clock-o"></span>'.$dt.'</small>
	...
	public function chat_message()
	{
	    ...
	    if($res)
	    {
	        ...
	        //$this->db->where(array('sender_id'=>$data['receiver_id'],'receiver_id'=>$data['sender_id']));
...
{   
   ...
   <small class="text-muted"><span class="fa fa-clock-o"></span>'.$dt.'</small>
	...
	//GET Chat List in admin
	public function client_list1($id='')
	{
	        $query = "SELECT * FROM `chat_count` where agent_id = ".$id." ";
            $list = $this->db->query($query)->result_array();
            ?>
                <ul class="sidebar-menu " style="overflow: inherit;" >
                        <?php  if($list){ $count=1; foreach($list as $row)
                        {
                            $data = "SELECT count(*) as notification_c FROM `chats` where sender_id IN(".$row['client_id'].",".$this->session->userdata('user_id').") and receiver_id IN(".$row['client_id'].",".$id.")  and notification_count = 1 GROUP BY sender_id";
    	                    $messages = $this->db->query($data)->row();
    	                    $noti =0;
                        ?>
                            <li class="">
                                <a class="" onclick="myFunctionone('<?=$row['client_id']?>','<?=$id?>','<?=$row['category_id']?>')" >
   ...
   <small class="text-muted"><span class="fa fa-clock-o"></span>'.$dt.'</small>
	...
	public function agent_chat_view()
	{
		...
		foreach($messages as $row)
		{
			...
			$category_Name = $this->db->get_where('category_adds',array('id'=>$category_id))->row()->category_name;
...
{   
   ...
   <small class="text-muted"><span class="fa fa-clock-o"></span>'.$dt.'</small>
       ...
       else
       {
					echo ' <li class="left clearfix"><span class="chat-img pull-left">
                             ...
                             <i class="fa fa-circle on-active" aria-hidden="true"></i>
                              ...
                              <div class="chat-body clearfix">
                                  <div class="header">
                                      <strong class="primary-font">'.$reciver_name.'('.$category_Name.')</strong> <small class="pull-right text-muted">
                                          <span class=" fa fa-clock-o"></span>'.$dt.'</small>
                                  </div>
                                  <p>';
                                  ?>
	...
	//DEMO1
	public function services($id='',$trip='')
	 {
	    if($this->session->userdata('auth_level')) 
		{ 
			if($this->session->userdata('role') =='admin')
			{
				...
				$data['user_info']      = $this->common_m->get_user_details();
				//get 10 tables
				$data['adds']          = $this->crms_m->get_hotel_user_data($id,$trip);
				$data['train']         = $this->crms_m->get_air_train_user_data($id,$trip);
 				$data['craft'] 		   = $this->crms_m->get_air_craft_user_data($id,$trip);
 				$data['boat'] 		   = $this->crms_m->get_boat_user_data($id,$trip);
				$data['cargo'] 		   = $this->crms_m->get_cargo_user_data($id,$trip);
				$data['driver'] 	   = $this->crms_m->get_driver_user_data($id,$trip);
				$data['cruise'] 	   = $this->crms_m->get_cruise_user_data($id,$trip);
				$data['event'] 		   = $this->crms_m->get_event_user_data($id,$trip);
				$data['company_fees'] 		   = $this->crms_m->get_company_user_data($id,$trip);
				$data['miscellaneous'] 		   = $this->crms_m->get_miscellaneous_user_data($id,$trip);
	...
	//view Services
	public function view_services($id='',$trip='')
	 {
	    if($this->session->userdata('auth_level')) 
		{ 
			if($this->session->userdata('role') =='admin')
			{
				$data['current_page']   ="view_services";
				$data['page_name']      ="view_services";
				$data['user_info']      = $this->common_m->get_user_details();	
   ...
   public function class_type($id='')
	...
	public function generate_invoice($id='',$value='',$trip='trip')
	 {
	    if($this->session->userdata('auth_level')) 
		{ 
			if($this->session->userdata('role') =='admin')
			{
				...
				$data['adds']           = $this->crms_m->get_hotel_user_data($client_id,$value,$trip);
				$data['train']          = $this->crms_m->get_air_train_user_data($client_id,$value,$trip);
 				$data['craft'] 		    = $this->crms_m->get_air_craft_user_data($client_id,$value,$trip);
 				$data['boat'] 		    = $this->crms_m->get_boat_user_data($client_id,$value,$trip);
				$data['cargo'] 		    = $this->crms_m->get_cargo_user_data($client_id,$value,$trip);
				$data['driver'] 		= $this->crms_m->get_driver_user_data($client_id,$value,$trip);
				$data['cruise'] 		= $this->crms_m->get_cruise_user_data($client_id,$value,$trip);
				$data['event'] 		    = $this->crms_m->get_event_user_data($client_id,$value,$trip);
				$data['company_fees'] 	= $this->crms_m->get_company_user_data($client_id,$value,$trip);
				$data['miscellaneous'] 	= $this->crms_m->get_miscellaneous_user_data($client_id,$value,$trip);
				
				$data['fee_management'] = $this->db->get('fee_management')->row_array();
				$data['bank_details'] 	= $this->db->get('bank_details')->row_array();
				$data['FCR'] 	        = $this->db->select('id,country_code')->get('FCR')->result_array();
	...
	public function generate_quotation($id='',$value='',$trip='trip')
	 {
	    if($this->session->userdata('auth_level')) 
		{ 
			if($this->session->userdata('role') =='admin')
  ...
  //$grand_total = $adds_amount + $train_amount + $craft_amount + $boat_amount  + $driver_amount ;
	...
	public function get_name()
	{
	   ...
	   $name = $this->db->where('supplier_code',$id)->where('service_type',$service_type)->get('suppliers')->row();
	   //echo $this->db->last_query(); exit;
	...
	/*//get supplyser name 
	public function get_client_code($value='')
	{
	   $user_id = $this->input->post('user_id');
	   //$service_name = $this->input->post('service_name');
	  // print_r($user_name);
	   $id = $this->db->where('user_id',$user_id)->get('users')->row(); 
	 // echo $this->db->last_query(); exit;
	   $res = $this->db->get_where('users',$id)->result();
	   foreach ($res as $key => $value) {
	   
	   if(@$id->user_id==$value->user_id)
	   {
	   	echo "<option value ='".$value->user_id."' selected >CC ".$value->user_id."</option>";
	   }else
	   {
	   	echo "<option value ='".$value->user_id."'  >CC ".$value->user_id."</option>";
	   }
	   }
	}*/
	...
	public function local_city($id='')
	{
	    if($this->session->userdata('auth_level')) 
		{ 
			if($this->session->userdata('role') =='admin')
			{
				$data['current_page']   ="local_city";
				$data['page_name']      ="local city";
				$data['user_info']      = $this->crms_m->get_user_details();
				$data['local']         = $this->crms_m->get_local_city();
				//print_r($data['class']); exit;
				$this->load->view('admin/includes/header',$data);
				$this->load->view('admin/includes/footer');
				$this->load->view('admin/local_city',$data);
			}
			else
			{
				redirect(base_url().'home/index');
...
//Save Agent Login 
	...
	public function logoutAgent($id='',$url='')
	{      
	...
	{
	    $id = $this->input->post('id');
	    $val = $this->input->post('getValue');
	    
	    $this->db->where('id',$id);
	    $res = $this->db->update('category_adds',array('orderType'=>$val));
	    ...
	    {
	        $this->session->set_flashdata('success','Some Thing Problem Please Try Again !');
	        echo json_encode(["status"=>"success","message"=>"Some Thing Problem Please Try Again"]);
	    }
	}
	
	//10/10/2018 Login Info
	public function log_info($id='')
	{
	    if($this->session->userdata('auth_level')) 
		{ 
		    $data['current_page']   ="log_info";
			$data['page_name']      ="Login Information";
			$data['user_info']      = $this->common_m->get_user_details();
			
			$data['ip_address']      = $this->common_m->get_ip_details('login_info',$id);
			
			$this->load->view('admin/includes/header',$data);
			$this->load->view('admin/includes/footer');
			$this->load->view('admin/log_info');	
	...
	//16/11/2018 FCR Rate
	public function fcr($id='')
	{
	    if($this->session->userdata('auth_level')) 
		{
		    $data['current_page']   ="fcr";
			$data['page_name']      ="FCR Rate";
			$data['user_info']      = $this->common_m->get_user_details();
			$data['fcr']            = $this->crms_m->get_fcr($id);
			
			$this->load->view('admin/includes/header',$data);
			$this->load->view('admin/includes/footer');
			$this->load->view('admin/fcr');
		}
		else
		{
			redirect(base_url().'home/index');
	...
	//19/11/2018 Get X-rate 
	public function getXrate()
	{
	    $id = $this->input->post('id');
	    if($id)
	    {
	        $data = $this->db->where('id',$id)->get('FCR')->row();
	        echo $data->new_rate.','.$data->old_rate;
	    }
	}
	
    
    //Date 18/12/2018 get_trip_id
    public function get_trip_id()
    {
        $clientCode = $this->input->post('id');
        $record = $this->db->select('id')->where('client_code',$clientCode)->get('trip')->result_array();
    ...
    //Date 18/06/2019 fee_management
    public function fee_management()
    {
        if($this->session->userdata('auth_level')) 
		{
            if($_POST)
            {
                $data = $this->input->post('data');
                $data['update_date'] = date('Y-m-d H:i:s');
                $this->db->set($data)->where('id',1)->update('fee_management');
                //echo $this->db->last_query();die;
                $this->session->set_flashdata('success','Data Updated successfully !');
                redirect(base_url().'admin/fee_management');
            }
            
            $data['current_page']   ="fees";
    		$data['page_name']      ="Fee Management";
    		$data['user_info']      = $this->common_m->get_user_details();
    		
    		$data['value']          = $this->db->get('fee_management')->row_array();     
            $this->load->view('admin/includes/header',$data);
    		$this->load->view('admin/includes/footer');
    ...
    public function bank_details()
    {
        if($this->session->userdata('auth_level')) 
		{
            if($_POST)
            {
                $data = $this->input->post('data');
                $data['update_date'] = date('Y-m-d H:i:s');
                $this->db->set($data)->where('id',1)->update('bank_details');
                //echo $this->db->last_query();die;
                $this->session->set_flashdata('success','Data Updated successfully !');
                redirect(base_url().'admin/bank_details');
            }
            
            $data['current_page']   ="bank_details";
    		$data['page_name']      ="Bank Details";
    		$data['user_info']      = $this->common_m->get_user_details();
    		$data['value']          = $this->db->get('bank_details')->row_array();   
            $this->load->view('admin/includes/header',$data);
    		$this->load->view('admin/includes/footer');
